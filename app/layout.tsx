  ...
  return (
    <html lang="en">
      <body className={inter.className}>
        ...
        {/* Google Analytics Raw Script */}
        <script async src="https://www.googletagmanager.com/gtag/js?id=G-YKM625JX7K"></script>
        <script
        ...
        <script
          dangerouslySetInnerHTML={{
            __html: `
              ...
              })(window, document, "clarity", "script", "wncngwuy6g");
            `,
          }}
        />
      </body>
